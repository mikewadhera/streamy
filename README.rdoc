...
* Code: script containing logic on how to process stream
  More specifically, an executable file that processes JSON Objects on standard input/output
* Sources: 0 or more source streams
* Sinks: 0 or more listening streams
* Cores: 0 or more running Unix processes executing script
